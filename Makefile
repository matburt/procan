...
freebsd:
	...
	@gcc -g -Wall -o procan -lcurses -lpanel -lkvm -lpthread procan.c analyzer.c freebsd_collector.c config.c backend.c cli.c
openbsd:
	@echo "Building the OpenBSD make target with the debug flag."
	@gcc -g -Wall -o procan -lcurses -lpanel -lpthread procan.c analyzer.c openbsd_collector.c config.c backend.c cli.c
linux:
